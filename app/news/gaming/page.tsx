...
export const metadata: Metadata = {
  title: "Gaming News | CINRYVAN",
  description:
    "Read the latest gaming news, esports updates, console headlines, PC gaming stories, mobile gaming news, releases, and industry updates on CINRYVAN.",
  alternates: {
  ...
  openGraph: {
    title: "Gaming News | CINRYVAN",
    description:
      "Latest gaming, esports, console, PC, mobile, and industry news on CINRYVAN.",
    url: "/news/gaming",
    siteName: "CINRYVAN",
    images: ["/og-image.png"],
    type: "website",
...
const gamingJsonLd = {
  ...
  url: "https://cinryvan.vercel.app/news/gaming",
};
