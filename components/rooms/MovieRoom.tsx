...
const roomLinks = [
  ...
  { icon: "🎬", href: "/rooms/cinryvan/movie", label: "Movies" },
  { icon: "📺", href: "/rooms/cinryvan/tv", label: "TV" },
  { icon: "⚡", href: "/rooms/cinryvan/anime", label: "Anime" },
  { icon: "🎨", href: "/rooms/cinryvan/cartoons", label: "Cartoons" },
  { icon: "🔥", href: "/rooms/cinryvan/spoilers", label: "Spoilers" },
  { icon: "📰", href: "/rooms/cinryvan/news", label: "News" },
  { icon: "🎮", href: "/rooms/cinryvan/gaming", label: "Gaming" },
];
...
export default function MovieRoom({
  ...
  const roomKey = `cinryvan:movie:${selectedChannel.slug}`;
                ...
                <div className="space-y-1">
                  {movieChannels.map((channel) => {
                    ...
                    return (
                      <Link
                        key={channel.slug}
                        href={`/rooms/cinryvan/movie?channel=${channel.slug}`}
